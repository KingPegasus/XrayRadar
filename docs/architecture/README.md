...
| [Auth](auth.md) | User authentication: signup, login, session, email verification, password reset, and signup-triggered admin notifications |
...
| [Admin](admin.md) | Admin UI (GitHub OAuth), admin API (tokens, users, token requests, deletion requests), and admin notification emails (signup, token request) |
