...
- **Version**
  - Bumped application version to **0.19.0** in `pyproject.toml`, FastAPI app metadata, and `xrayradar-web/package.json`.
- **Backend dependencies**
  - Raised minimum constraints and refreshed `uv.lock`: FastAPI 0.138.1, Uvicorn 0.49.0, SQLAlchemy 2.0.51, Alembic 1.18.5, Resend 2.32.2, slowapi 0.1.10, pytest 9.1.1, pip-audit 2.10.1, and transitive updates.
- **Frontend dependencies**
  - React 19.2.7, Vite 8.1.0, Vitest 4.1.9, `@vitejs/plugin-react` 6.0.3.
...
- **Dependencies**
  ...
  - Dev extra: `pygments` installed from git **master** (includes Pygments [#3064](https://github.com/pygments/pygments/pull/3064) for CVE-2026-4539); `uv.lock` pins the resolved commit. Revert to a normal PyPI constraint when a patched release ships.
